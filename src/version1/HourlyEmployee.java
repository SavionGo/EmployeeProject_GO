...
public class HourlyEmployee {
    ...
    public String toString() {
        return "HourlyEmployee {" + "empID=" + empID + ", empName=" + empName + ", totalHoursWorked=" + String.format("%.2f", totalHoursWorked) + ", ratePerHour=$" + String.format("%.2f", ratePerHour) + ", Total Salary=$" + String.format("%.2f", computeSalary()) + '}';
    }
